...
title @a actionbar [{"text":"邊界中心","color":"green"},{"score":{"name":"#center_x","objective":"uhc_center_x"},"color":"yellow"},{"text":", ","color":"green"},{"score":{"name":"#center_z","objective":"uhc_center_z"},"color":"yellow"}]

scoreboard players add #timer uhc_timer 1

# 檢查縮圈時間
execute if score #timer uhc_timer = #phase1 uhc_timer run function mypack:shrink
execute if score #timer uhc_timer = #phase2 uhc_timer run function mypack:shrink
execute if score #timer uhc_timer = #phase3 uhc_timer run function mypack:shrink
execute if score #timer uhc_timer = #phase4 uhc_timer run function mypack:shrink
execute if score #timer uhc_timer = #phase5 uhc_timer run function mypack:shrink
execute if score #timer uhc_timer = #phase6 uhc_timer run function mypack:shrink

# 檢查玩家位置
function mypack:check_players
...
execute if score #timer uhc_timer matches 34800 run tellraw @a [{"text":"[UHC] ","color":"gold","bold":true},{"text":"距離縮圈還有 1 分鐘","color":"red"}]
execute if score #timer uhc_timer matches 35400 run tellraw @a [{"text":"[UHC] ","color":"gold","bold":true},{"text":"距離縮圈還有 30 秒","color":"red"}]
execute if score #timer uhc_timer matches 35800 run tellraw @a [{"text":"[UHC] ","color":"gold","bold":true},{"text":"距離縮圈還有 10 秒","color":"red"}]
...
execute if score #timer uhc_timer matches 70800 run tellraw @a [{"text":"[UHC] ","color":"gold","bold":true},{"text":"距離縮圈還有 1 分鐘","color":"red"}]
execute if score #timer uhc_timer matches 71400 run tellraw @a [{"text":"[UHC] ","color":"gold","bold":true},{"text":"距離縮圈還有 30 秒","color":"red"}]
execute if score #timer uhc_timer matches 71800 run tellraw @a [{"text":"[UHC] ","color":"gold","bold":true},{"text":"距離縮圈還有 10 秒","color":"red"}]